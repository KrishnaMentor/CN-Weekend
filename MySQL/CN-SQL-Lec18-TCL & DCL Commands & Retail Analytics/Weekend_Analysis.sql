...
INSERT INTO bank_transactions (account_id, balance, remarks)
VALUES (1 , -500, 'Paying for Grocery');

COMMIT; 
ROLLBACK; -- If System Crashes Rollback hit instanly.

-- CONTINOUS TRANSACTION.
START TRANSACTION;

INSERT INTO bank_transactions (account_id, balance, remarks)
VALUES (1 , 300, 'Deposit');
...
-- DURABALITY -- Changes Persist after Commit.... 
START TRANSACTION;
